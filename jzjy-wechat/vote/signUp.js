	...
	$("#uploadBehindImage").change(function() {
		...
		reader.onload = function(e) {
			...
			image.onload = function() {
				...
				formData.append('files', files);  //添加图片信息的参数
