                ...
                return new a(function(n, a) {
                    i.onerror = function() {
                        ...
                        e._getBase64().then(function(e) {
                            ...
                            var i = null;
                            var bool = e.defaults.big2type ? "object" == typeof e.file && r.length > e.file.size : true;
                            bool ? (i = new FormData, t = e.file) : (i = new s.FormData, t = o(r)), i.append(e.defaults.fieldName, t, e.fileName.replace(/\..+/g, ".jpg")), n({
                                formData: i,
                                fileLen: +t.size,
                                base64: r,
                                base64Len: r.length,
